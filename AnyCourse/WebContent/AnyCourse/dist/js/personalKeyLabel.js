		...
		success:function(result){
    		for(var i = 0 ;i < result.length;i++){
    			$('#KeyLabelList').append('<li class="list-group-item" id="searchRecordID_'+ (i+1) +'">'
						...
						+'<div class="col-xs-2 text-center"><a href="../PlayerInterface.html?type='+ (result[i].url.split("/")[2]=="www.youtube.com"?1:2) + '&unitId='+result[i].unitId+'">' + result[i].keyLabelName + '</a></div>'
